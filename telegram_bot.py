...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "📄 *Basic* — бесплатно\n"
        "Ключевые метрики, 5 графиков, топ-20 товаров\n\n"
        "📊 *Standard* — 2 500 ₽\n"
        "Мастер-анализ AI, юнит-экономика, "
        "рекламная стратегия, сезонный план\n\n"
        "📈 *Deep* — 6 000 ₽\n"
        "Всё из Standard + анализ конкурентов, "
        "поиск поставщиков, 90-дневный план запуска\n\n"
        "👇 Нажми чтобы начать:",
        parse_mode="Markdown",
